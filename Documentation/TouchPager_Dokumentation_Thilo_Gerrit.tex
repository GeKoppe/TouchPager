...
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.55]{Bilder/Class_Diagram.png}
        \caption{Vereinfachtes Klassendiagramm des Arduino Programms}\label{diag:classdiag}
    \end{center}
\end{figure}
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.4]{Bilder/Menüführung.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.3]{Bilder/Verfügbarkeit.png}
...
\begin{flushleft}\textbf{Beispiel Menüführung: Optionenmenü}\label{code:menu}\end{flushleft}
\begin{lstlisting}
/**
 * @brief 
 * Options menu
...
\begin{flushleft}
    \textbf{Nachrichten zwischenspeichern}\label{code:cache}
\end{flushleft}
\begin{lstlisting}
/**
* @brief 
...
\begin{enumerate}
    \item nRF24L01+ Transceiver: \url{https://www.amazon.de/nRF24L01-Antenne-kabellos-Transceiver-Arduino/dp/B07TYVSSBZ/}\label{itm:transceiverlink}
    \item Elegoo Arduino Mega R3: \url{https://www.amazon.de/Elegoo-Kompatibler-Mikrocontroller-Mega2560R3-ATmega2560/dp/B071D4KP6B/}\label{itm:arduinolink}
    \item Elegoo TFT Touchscreen: \url{https://www.amazon.de/ELEGOO-Touchscreen-Arduino-Bibliotheken-Mitgeliefert/dp/B01EUVJYME/}\label{itm:tftlink}
\end{enumerate}
