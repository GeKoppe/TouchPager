...
Testfälle: in verschiedenen Distanzen mit jeder Stärke mindestens 3 Nachrichten senden. Hier Graphen erstellen?

\subsection{Soll-Ist-Vergleich}
Erreichte Ziele: Alle

\subsection{Ausblick}
Bro du kannst basically alles damit machen, das Ding kann noch extrem viel mehr, einfach weil touch.
\\
Case wäre cool
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.7]{Bilder/Class_Diagram.png}
