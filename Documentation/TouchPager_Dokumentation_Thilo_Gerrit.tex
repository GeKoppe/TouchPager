...
Anschließend werden wir auf die Planung der Ressourcen und des Ablaufs, sowie auf die benötigten Komponenten eingehen.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.2\textwidth}|p{0.5\textwidth}|p{0.2\textwidth}|}
        ...
        Arduino.h
        &
        Liefert Kernfunktionen der Arduino Boards.0
        &
        In Arduino IDE inkludiert
        \\
        \hline
